...
explosion1_efecto = pygame.mixer.Sound(f"efectos/explosion2.wav")
explosion1_efecto.set_volume(0.25)
explosion2_efecto = pygame.mixer.Sound(f"efectos/explosion2.wav")
explosion2_efecto.set_volume(0.25)
contacto_efecto = pygame.mixer.Sound(f"efectos/contacto1.wav")
contacto_efecto.set_volume(0.25)
contacto2_efecto = pygame.mixer.Sound(f"efectos/contacto2.wav")
